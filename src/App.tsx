...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <header className="relative overflow-hidden hero-section min-h-screen flex items-center pb-20 md:pb-0">
        <div className="absolute inset-0 hero-pattern opacity-30"></div>

        <nav className="fixed top-0 left-0 right-0 bg-blue-500/95 backdrop-blur-sm px-6 py-4 z-40">
          <div className="container mx-auto flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="https://app.b2vendas.com.br/login" target="_blank" rel="noopener noreferrer">
        ...
        <div className={`mobile-menu ${isMobileMenuOpen ? 'open' : 'closed'}`}>
          ...
          <div className="flex flex-col pt-24">
            ...
            <div className="p-6 space-y-4 gap-2">
              <a href="https://app.b2vendas.com.br/login" target="_blank" rel="noopener noreferrer" className='w-full'>
                <button className="w-full bg-white text-blue-500 px-6 py-3 rounded-xl hover:bg-white/90 transition-all mb-2 font-semibold">
                  Login
                </button>
              </a>
              <a href="https://app.b2vendas.com.br/registre-se" target="_blank" rel="noopener noreferrer" className='mt-2'>
          ...
          <div className="md:flex items-center gap-12">
            <div className="md:w-1/2 space-y-8">
              <div className="flex flex-col gap-3">
                <div className="inline-flex items-center glass-card px-4 py-2 mb-2 text-white self-start">
                  <span className="mr-2">🚀</span>
                  Plataforma líder em B2B
                </div>
                <div className="trial-badge self-start flex items-center gap-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="https://app.b2vendas.com.br/registre-se" target="_blank" rel="noopener noreferrer" className='w-full'>
                  <button className="bg-white text-blue-500 px-8 w-full py-4 rounded-xl font-semibold hover:bg-white/90 transition-all flex items-center justify-center group">
                ...
                <a href="https://app.b2vendas.com.br/login" target="_blank" rel="noopener noreferrer" className='w-full'>
                  <button className="glass-card text-white px-8 py-4 w-full rounded-xl font-semibold hover:bg-white/20 transition-all flex items-center justify-center group">
                    Acessar Plataforma
                    <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" />
                  </button>
                </a>
            ...
            <div className="md:w-1/2 mt-16 md:mt-0">
              <div className="relative">
                <img
                  ...
                  className="rounded-2xl shadow-2xl border-4 border-white/20 animate-float"
                />
                <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-4 shadow-xl animate-float">
